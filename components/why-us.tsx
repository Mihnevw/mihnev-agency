...
export default function WhyChooseUs() {
  ...
  return (
    <section id="why-choose-us" className="py-20 bg-white dark:bg-slate-900 relative overflow-x-hidden">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-4 w-full max-w-[100vw] relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="hidden md:block">
            <StaggerContainer className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 lg:gap-8 px-4 sm:px-0">
